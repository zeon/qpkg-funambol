...
set CLASSPATH="%JDBC_JAR%;%DS_SERVER_HOME%\bin\log4j.properties;%DS_SERVER_HOME%\bin;%CLASSPATH%"
...
"%JAVA_HOME%\bin\java.exe" %JAVA_OPTS% com.funambol.server.util.UserPasswordsEncryptor install.properties
